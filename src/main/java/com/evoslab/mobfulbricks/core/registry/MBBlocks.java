...
public class MBBlocks {
    ...
    public static final RegistryObject<Block> POLAR_BEAR_BRICK_WALL = HELPER.createBlock("polar_bear_brick_wall", () -> new WallBlock(Block.Properties.from(Blocks.STONE_BRICKS)), ItemGroup.BUILDING_BLOCKS);
